from security.platform.contracts import PlatformInfo
from security.platform.factory import resolve_platform_ops


def test_security_platform_scaffold_contract_and_factory() -> None:
