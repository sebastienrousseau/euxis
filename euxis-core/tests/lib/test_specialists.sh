...
assert_file_exists "crypto-cryptography-auditor prompt" "${EUXIS_HOME}/euxis-core/agents/prompts/fleet/crypto-cryptography-auditor.txt"
assert_file_exists "payments-domain-steward prompt" "${EUXIS_HOME}/euxis-core/agents/prompts/fleet/payments-domain-steward.txt"
assert_file_exists "realtime-audio-engineer prompt" "${EUXIS_HOME}/euxis-core/agents/prompts/fleet/realtime-audio-engineer.txt"
assert_file_exists "rust-crate-steward prompt" "${EUXIS_HOME}/euxis-core/agents/prompts/fleet/rust-crate-steward.txt"
