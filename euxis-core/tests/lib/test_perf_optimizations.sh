...
mem_file="${EUXIS_HOME}/euxis-core/lib/memory.sh"
...
skill_file="${EUXIS_HOME}/euxis-core/lib/skill-detector.sh"
...
session_file="${EUXIS_HOME}/euxis-core/lib/session.sh"
...
prompt_file="${EUXIS_HOME}/euxis-core/lib/prompt.sh"
...
# ===== template.sh: No sed =====
tpl_file="${EUXIS_HOME}/euxis-core/lib/template.sh"
...
# ===== Boot guards exist =====
euxis_file="${EUXIS_HOME}/euxis-cli/bin/euxis.sh"
