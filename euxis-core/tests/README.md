...
Tests contain cross-module integration and verification suites.
...
- `cli/` — CLI entrypoints
- `api/src/gateway/` — gateway interfaces
- `ui/src/tui/` — UI screens

## Usage
```bash
core/tests/run_shell_tests.sh
pytest -q
```
...
core/tests/run_shell_tests.sh --focus lint

# Run a focused pytest file
pytest ui/tests/unit/test_app.py
```
...
## API / Exports
This module exports test runners and helpers under `core/tests/`.
