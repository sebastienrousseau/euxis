...
setup() {
    ...
    export PROJECTS_DIR="${EUXIS_HOME}/euxis-runtime/data/projects"
...
@test "ensure_project_dirs creates agent directory" {
    ...
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect" ]]
}

@test "ensure_project_dirs creates output subdirectory" {
    ensure_project_dirs "test-project" "architect"
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/output" ]]
}

@test "ensure_project_dirs creates audit.md" {
    ensure_project_dirs "test-project" "architect"
    [[ -f "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md" ]]
}

@test "ensure_project_dirs creates memory.md" {
    ensure_project_dirs "test-project" "architect"
    [[ -f "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/memory.md" ]]
}

@test "ensure_project_dirs audit.md has correct header" {
    ensure_project_dirs "test-project" "architect"
    grep -q "# Audit Log: architect" "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md"
}

@test "ensure_project_dirs memory.md has correct header" {
    ensure_project_dirs "test-project" "architect"
    grep -q "# Memory: architect" "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/memory.md"
}

@test "ensure_project_dirs does not overwrite existing files" {
    ensure_project_dirs "test-project" "architect"
    echo "Custom content" >> "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md"

    ensure_project_dirs "test-project" "architect"
    grep -q "Custom content" "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md"
}

@test "ensure_project_dirs handles nested project names" {
    ensure_project_dirs "org/repo" "architect"
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/org/repo/architect" ]]
}
...
@test "ensure_project_dirs handles multiple agents" {
    ...
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect" ]]
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/tester" ]]
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/debugger" ]]
}

@test "ensure_project_dirs handles hyphenated agent names" {
    ensure_project_dirs "test-project" "bug-fixer"
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/bug-fixer" ]]
    [[ -f "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/bug-fixer/memory.md" ]]
}
...
@test "ensure_project_dirs handles special characters in agent name" {
    ...
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/agent_with_underscore" ]]
}
...
@test "ensure_project_dirs is idempotent" {
    ensure_project_dirs "test-project" "architect"
    local audit_mtime1
    audit_mtime1=$(stat -c '%Y' "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md" 2>/dev/null || stat -f '%m' "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md")

    sleep 1
    ensure_project_dirs "test-project" "architect"
    local audit_mtime2
    audit_mtime2=$(stat -c '%Y' "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md" 2>/dev/null || stat -f '%m' "${EUXIS_HOME}/euxis-runtime/data/projects/test-project/architect/audit.md")
...
@test "full session workflow" {
    ...
    [[ -d "${EUXIS_HOME}/euxis-runtime/data/projects/${project}/architect" ]]

    local memory_path="${EUXIS_HOME}/euxis-runtime/data/projects/${project}/architect/memory.md"
