...
class TestSingleAgentDispatch(unittest.TestCase):
    ...
    def test_dispatch_single_agent_basic(self, mock_setup_log, mock_popen):
    ...
    def test_dispatch_single_agent_mesh_mode(self, mock_setup_log, mock_popen):
    ...
    def test_dispatch_single_agent_federated_mode(self, mock_setup_log, mock_popen):
    ...
    def test_dispatch_single_agent_with_verify_cmd(self, mock_setup_log, mock_popen):
    ...
    def test_dispatch_single_agent_atomic_instructions(self, mock_setup_log, mock_popen):
