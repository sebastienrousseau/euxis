...
/// [[maybe_unused]] because the constant documents the policy but the
/// runtime check happens in higher-level callers, not here.
[[maybe_unused]] constexpr size_t kMaxMessageSize = 256ULL * 1024 * 1024;
