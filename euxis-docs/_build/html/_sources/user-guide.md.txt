...
| Guide | Description |
|-------|-------------|
| [User Guide](guides/user-guide.md) | Complete CLI reference, agent fleet, provider matrix |
...
| [CLI Reference](reference/cli-reference.md) | Detailed CLI command reference |
