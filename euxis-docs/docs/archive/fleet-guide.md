...
**For complete memory system documentation, commands, and type classification, see [User Guide](guides/user-guide.md#tri-typed-memory-system).**
...
**For the complete provider matrix, intelligence tiering, and explicit override syntax, see [User Guide](guides/user-guide.md#ai-provider-matrix).**
