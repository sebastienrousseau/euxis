...
This commands reads the manifest, copies the metadata into the plugin directory (`~/.euxis/euxis-core/config/plugins/`), and activates the agent in your local installation.
