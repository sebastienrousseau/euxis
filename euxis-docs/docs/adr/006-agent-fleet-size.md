...
- **Coordination overhead:** Measured via $EUXIS_HOME/metrics/events.jsonl. Latency budgets enforce that prompt assembly stays <500ms and total overhead stays predictable regardless of fleet size.
