...
from euxis.llm.providers.openai import get_openai_command_specs

if TYPE_CHECKING:
    from euxis.agent.agent import Agent

from euxis.config import Config
from euxis.llm.api_manager import ApiManager
from euxis.llm.base import ChatSequence, Message
from euxis.llm.utils import count_message_tokens, create_chat_completion
from euxis.log_cycle.log_cycle import CURRENT_CONTEXT_FILE_NAME
...
def chat_with_ai(
    ...
    current_tokens_used += (
        500  # Reserve space for the openai functions TODO improve
    )
    ...
    #  https://www.github.com/Sebastian Rousseau/Euxis"
