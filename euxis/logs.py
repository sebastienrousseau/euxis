...
from euxis.log_cycle.json_handler import JsonFileHandler, JsonFormatter
    ...
    def double_check(self, additionalText=None):
        if not additionalText:
            additionalText = (
                ...
                " correctly. Read https://github.com/Sebastian Rousseau/Euxis#readme to "
...
def print_assistant_thoughts(
    ...
    assistant_thoughts_text = remove_ansi_escape(
        assistant_thoughts.get("text")
    )
