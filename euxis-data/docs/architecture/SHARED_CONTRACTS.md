...
**Consumer:** `euxis-bin/euxis*` (CLI tools)
...
|------------|-----------|----------|-----------|----------------|
| v0.0.3      | v0.0.3     | v0.0.3    | v0.0.3     | v0.0.3          |
...
*Document created:-02-16 as part of v0.0.3 multi-repo preparation*
