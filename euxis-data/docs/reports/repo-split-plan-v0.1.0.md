...
- `euxis-bin/euxis.sh` sources `core/lib/*.sh` (`core/lib/common.sh`, `providers.sh`, `agents.sh`, `memory.sh`, `session.sh`, `template.sh`, `skill-detector.sh`, `prompt.sh`, `cli.sh`, `dispatch.sh`).
  - Evidence: `euxis-bin/euxis.sh:74-100`.
- Nearly every CLI script sources `core/lib/core.sh`.
  - Evidence: `euxis-bin/euxis-*.sh` list in `rg` results.
