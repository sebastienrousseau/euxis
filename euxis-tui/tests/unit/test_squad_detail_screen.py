...
class TestSquadDetailScreen(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.registry.agents = [
            Agent(
                id="architect", tier="core", version="0.0.1",
                tags=("design",), activation="default",
            ),
            Agent(
                id="debugger", tier="fleet", version="0.0.1",
                tags=("fix",), activation="default",
            ),
            Agent(
                id="tester", tier="fleet", version="0.0.1",
                tags=("qa",), activation="default",
            ),
            Agent(
                id="reviewer", tier="core", version="0.0.1",
...
class TestSquadDetailScreenMounting(unittest.TestCase):
    ...
    def test_on_mount_with_squads(self):
        ...
        self.registry.agents = [
            ...
            Agent(id="debugger", tier="fleet", version="0.0.1", tags=(), activation="default"),
        ]
        self.registry.squads = [
    ...
    def test_core_agent_highlighting(self):
        ...
        self.registry.agents = [
            Agent(id="core-agent", tier="core", version="0.0.1", tags=(), activation="default"),
            Agent(id="fleet-agent", tier="fleet", version="0.0.1", tags=(), activation="default"),
        ]
        self.registry.squads = [
...
class TestSquadDetailScreenPropertyBased(unittest.TestCase):
    ...
    def test_agent_list_robustness(self, agent_ids):
        ...
        registry.agents = [
            Agent(id=aid, tier="fleet", version="0.0.1", tags=(), activation="default")
