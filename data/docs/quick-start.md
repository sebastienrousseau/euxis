...
OBSERVATION 1: Found: euxis-bin/, config/, euxis-policy/, euxis-data/runtime/memory/, metrics/src/metrics/, euxis-data/runtime/, docs/, agents/, tests/, ui/src/tui/, api/src/gateway/, adapters/src/adapters/
