# Euxis Monorepo Reorg Plan (v0.0.3)
...
- `euxis-bin/` mixes user-facing commands with internal helpers.
...
- **Contains**: `euxis-bin/euxis*`, `core/lib/`.
...
- `euxis-bin/euxis-gateway` → `euxis-bin/euxis-gateway`
