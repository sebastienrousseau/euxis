...
|-------|-------------------|
| [Choosing Coordination](core-concepts/choosing-coordination.md) | When to use agents, combos, squads, or playbooks |
| [Agent Selection](core-concepts/agent-selection.md) | How to pick the right agent |
