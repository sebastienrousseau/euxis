...
``` shell
python -m euxis --speak
```

Eleven Labs provides voice technologies such as voice design, speech synthesis, and
premade voices that Euxis can use for speech.

1. Go to [ElevenLabs](https://beta.elevenlabs.io/) and make an account if you don't
    already have one.
2. Choose and setup the _Starter_ plan.
3. Click the top right icon and find _Profile_ to locate your API Key.
