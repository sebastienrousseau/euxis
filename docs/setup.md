...
Choose an environment to run Euxis in (pick one):
...
!!! attention
    To use the OpenAI API with Euxis, we strongly recommend **setting up billing**
...
2. Create a project directory for Euxis
...
3. In the project directory, create a file called `docker-compose.yml` with the following contents:
        ...
        services:
          auto-gpt:
            ...
            volumes:
              - ./auto_gpt_workspace:/app/euxis/auto_gpt_workspace
              - ./data:/app/data
...
!!! note "Docker only supports headless browsing"
    Euxis uses a browser in headless mode by default: `HEADLESS_BROWSER=True`.
    Please do not change this setting in combination with Docker, or Euxis will crash.

[Docker Hub]: https://hub.docker.com/r/significantgravitas/auto-gpt
[repository]: https://github.com/sebastienrousseau/euxis
...
1. Clone the repository
        ...
        :::shell
        git clone -b stable https://github.com/sebastienrousseau/euxis.git
...
1. Download `Source code (zip)` from the [latest stable release](https://github.com/sebastienrousseau/euxis/releases/latest)
2. Extract the zip-file into a folder

### Configuration

1. Find the file named `.env.template` in the main `Euxis` folder. This file may
...
Once you have a recent version of docker-compose, run the commands below in your Euxis folder.
