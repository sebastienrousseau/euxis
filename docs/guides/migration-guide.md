...
2. [Migrating from v0.0.9 to v0.1.2](#migrating-from-v009-to-v0010)
...
## Migrating from v0.0.9 to v0.1.2
...
All data config files (`registry.json`, `squads.json`, `router.json`, `capabilities.json`, `codex.json`) are bumped from `v0.0.3` to `v0.1.2`. These update automatically when you pull the latest code.
