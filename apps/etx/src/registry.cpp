...
void FleetRegistry::load_defaults() {
    ...
    agents_.push_back({
        ...
        "error", "agent", "fleet", "v0.0.10", "default", {}, {}, {}
    });
    agents_.push_back({
