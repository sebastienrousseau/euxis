...
void FleetRegistry::load_defaults() {
    ...
    agents_.push_back({
        ...
        "error", "agent", "fleet", "v0.1.3", "default", {}, {}, {}
    });
    agents_.push_back({
