...
case "${1:-}" in
  ...
  "" | -h | --help | help)
    ...
    ;;
  agents)
    source "${EUXIS_HOME}/euxis-bin/lib/cli.sh"
    usage_agents
    exit 0
    ;;
  search)
    ...
    ;;
  doctor)
    exec "${EUXIS_HOME}/euxis-bin/euxis-doctor" "${@:2}"
    ;;
esac
...
if [[ -f "${EUXIS_HOME}/euxis-bin/lib/core.sh" ]]; then
  # shellcheck source=core/lib/core.sh
  source "${EUXIS_HOME}/euxis-bin/lib/core.sh"
...
PROMPTS_DIR="${EUXIS_HOME}/euxis-data/agents/prompts"
PROJECTS_DIR="${EUXIS_HOME}/euxis-data/runtime/projects"
source "${EUXIS_HOME}/euxis-bin/lib/common.sh"
source "${EUXIS_HOME}/euxis-bin/lib/providers.sh"
source "${EUXIS_HOME}/euxis-bin/lib/agents.sh"
source "${EUXIS_HOME}/euxis-bin/lib/memory.sh"
source "${EUXIS_HOME}/euxis-bin/lib/session.sh"
source "${EUXIS_HOME}/euxis-bin/lib/template.sh"
source "${EUXIS_HOME}/euxis-bin/lib/skill-detector.sh"
source "${EUXIS_HOME}/euxis-bin/lib/prompt.sh"
source "${EUXIS_HOME}/euxis-bin/lib/cli.sh"
...
EUXIS_BIN="${EUXIS_HOME}/euxis-bin"
