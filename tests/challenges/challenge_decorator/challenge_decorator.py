...
CHALLENGE_FAILED_MESSAGE = "Challenges can sometimes fail randomly, please run this test again and if it fails reach out to us on https://discord.gg/euxis in the 'challenges' channel to let us know the challenge you're struggling with."
...
def challenge() -> Callable[[Callable[..., Any]], Callable[..., None]]:
    def decorator(func: Callable[..., Any]) -> Callable[..., None]:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> None:
            run_remaining = (
                MAX_LEVEL_TO_IMPROVE_ON if Challenge.BEAT_CHALLENGES else 1
            )
