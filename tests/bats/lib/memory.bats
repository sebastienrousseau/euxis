...
setup() {
    ...
    mkdir -p "${EUXIS_HOME}/data/projects/test-project/architect"
    mkdir -p "${EUXIS_HOME}/data/projects/test-project/tester"

    # Create mock memory files
    cat > "${EUXIS_HOME}/data/projects/test-project/architect/memory.md" << 'EOF'
# Memory: architect
...
EOF
    ...
    cat > "${EUXIS_HOME}/data/projects/test-project/tester/memory.md" << 'EOF'
# Memory: tester
...
@test "_validate_memory_path accepts valid path" {
    local valid_path="${EUXIS_HOME}/data/projects/test/memory.md"
...
@test "get_hot_memory returns recent entries" {
    local memory_file="${EUXIS_HOME}/data/projects/test-project/architect/memory.md"
...
@test "get_cross_agent_memory finds sibling agent context" {
    local project_dir="${EUXIS_HOME}/data/projects/test-project"
