...
@test "_perf_record writes JSONL metric to file" {
    ...
    [[ -f "${EUXIS_HOME}/data/perf/metrics.jsonl" ]]
    grep -q '"op":"test_op"' "${EUXIS_HOME}/data/perf/metrics.jsonl"
    grep -q '"ms":750' "${EUXIS_HOME}/data/perf/metrics.jsonl"
}
...
@test "_perf_record skips when disabled" {
    ...
    [[ ! -f "${EUXIS_HOME}/data/perf/metrics.jsonl" ]] || \
    [[ ! -s "${EUXIS_HOME}/data/perf/metrics.jsonl" ]]
}
