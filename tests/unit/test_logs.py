...
from euxis.logs import remove_color_codes
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "{'Schaue dir meine Projekte auf github () an, als auch meine Webseiten': 'https://github.com/sebastienrousseau/euxis, https://discord.gg/euxis und https://twitter.com/SigGravitas'}",
            "{'Schaue dir meine Projekte auf github () an, als auch meine Webseiten': 'https://github.com/sebastienrousseau/euxis, https://discord.gg/euxis und https://twitter.com/SigGravitas'}",
        ),
        ("", ""),
        ("hello", "hello"),
