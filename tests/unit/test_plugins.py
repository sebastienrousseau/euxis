...
from euxis.plugins import inspect_zip_for_modules, scan_plugins
from euxis.plugins.plugin_config import PluginConfig
from euxis.plugins.plugins_config import PluginsConfig

PLUGINS_TEST_DIR = "tests/unit/data/test_plugins"
PLUGIN_TEST_ZIP_FILE = "Euxis-Plugin-Test-master.zip"
PLUGIN_TEST_INIT_PY = (
    "Euxis-Plugin-Test-master/src/auto_gpt_vicuna/__init__.py"
)
...
def test_inspect_zip_for_modules():
    result = inspect_zip_for_modules(
        str(f"{PLUGINS_TEST_DIR}/{PLUGIN_TEST_ZIP_FILE}")
    )
